...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_HEAR = 8,                       /* HEAR  */
  YYSYMBOL_SPEAK = 9,                      /* SPEAK  */
  YYSYMBOL_ASSIGN = 10,                    /* ASSIGN  */
  YYSYMBOL_OP_IN = 11,                     /* OP_IN  */
  YYSYMBOL_OP_OUT = 12,                    /* OP_OUT  */
  ...
  YYSYMBOL_24_1 = 24,                      /* $@1  */
  YYSYMBOL_main_block = 25,                /* main_block  */
  YYSYMBOL_26_2 = 26,                      /* $@2  */
  ...
  YYSYMBOL_io_stmt = 32,                   /* io_stmt  */
  YYSYMBOL_return_stmt = 33,               /* return_stmt  */
...
{
       0,    37,    37,    37,    52,    51,    71,    72,    76,    84,
      85,    89,    90,    91,    95,   105,   114,   129,   134,   141,
     148,   153,   160,   165,   167,   173
};
#endif
...
static const char *const yytname[] =
{
  ...
  "INT", "MAIN", "RETURN", "HEAR", "SPEAK", "ASSIGN", "OP_IN", "OP_OUT",
  "PLUS", "MINUS", "MULT", "DIV", "LPAREN", "RPAREN", "LBRACE", "RBRACE",
  "SEMICOLON", "$accept", "program", "$@1", "main_block", "$@2",
  "decl_list", "decl", "stmt_list", "stmt", "assign_stmt", "io_stmt",
  "return_stmt", "expr", "term", "factor", YY_NULLPTR
};
...
{
     -37,    18,    15,   -37,    16,   -37,     4,     5,     6,    21,
      24,   -37,    21,     7,     8,   -37,   -37,    19,    26,    20,
      22,    12,     8,   -37,   -37,   -37,    -3,    14,    30,    -3,
     -37,   -37,   -37,   -37,    -3,   -11,    23,   -37,   -37,    25,
      -9,    -5,    -3,    -3,   -37,    -3,   -37,   -37,   -37,    23,
      23,   -37
};
...
{
       2,     0,     0,     1,     0,     3,     0,     0,     0,     7,
       0,     4,     7,     0,    10,     6,     8,     0,     0,     0,
       0,     0,    10,    11,    12,    13,     0,     0,     0,     0,
       5,     9,    24,    25,     0,     0,    20,    22,    17,     0,
       0,     0,     0,     0,    14,     0,    15,    16,    23,    18,
      19,    21
};
...
{
      32,    33,    42,    43,    42,    43,    49,    50,    42,    43,
      44,    17,    47,    48,    34,    18,    19,    20,     3,    40,
       4,     7,     6,     8,    41,     9,    10,    13,    16,    26,
      27,    28,    30,    39,    29,    38,     0,    51,    45,    15,
...
{
       3,     4,    13,    14,    13,    14,    42,    43,    13,    14,
      21,     3,    21,    18,    17,     7,     8,     9,     0,    29,
       5,    17,     6,    18,    34,    19,     5,     3,    21,    10,
       4,    11,    20,     3,    12,    21,    -1,    45,    15,    12,
...
{
       0,    23,    24,     0,     5,    25,     6,    17,    18,    19,
       5,    27,    28,     3,    26,    27,    21,     3,     7,     8,
       9,    29,    30,    31,    32,    33,    10,     4,    11,    12,
      20,    29,     3,     4,    17,    34,    35,    36,    21,     3,
      34,    34,    13,    14,    21,    15,    21,    21,    18,    35,
      35,    36
};
...
#line 1191 "translator.tab.c"
    break;

  case 15: /* io_stmt: HEAR OP_IN ID SEMICOLON  */
#line 106 "translator.y"
      {
        emit("    ; hear >> %s", (yyvsp[-1].str_val));
        emit("    lea rdi, [rel format_in]");
        emit("    lea rsi, [rel %s]", (yyvsp[-1].str_val));
        emit("    xor rax, rax");
        emit("    call scanf");
        free((yyvsp[-1].str_val));
      }
#line 1204 "translator.tab.c"
    break;

  case 16: /* io_stmt: SPEAK OP_OUT expr SEMICOLON  */
...
#line 135 "translator.y"
      {
        ...
        emit("    add eax, %s", (yyvsp[0].str_val));
        emit("    mov %s, eax", (yyval.str_val));
      }
#line 1231 "translator.tab.c"
    break;
...
#line 1242 "translator.tab.c"
    break;

  case 20: /* expr: term  */
#line 149 "translator.y"
      { (yyval.str_val) = (yyvsp[0].str_val); }
#line 1248 "translator.tab.c"
    break;
...
#line 1289 "translator.tab.c"
    break;


#line 1293 "translator.tab.c"
