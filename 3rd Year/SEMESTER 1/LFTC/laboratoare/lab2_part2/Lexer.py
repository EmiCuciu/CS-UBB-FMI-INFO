    ...
    def _process_line(self, line: str, line_num: int):
        ...
        while i < len(line):
            ...
            if ch == '"':
                ...
                i += 1  # sarim peste ghilimeaua de inchidere
                token = line[start:i]
            ...
            best_match_simple = ""
            for op_or_delim in defs.SORTED_op_del_key:
            ...
            if best_match_token:
                ...
                print(f"Eroare Lexicala [Linia {line_num}, Coloana {i}]: Simbol necunoscut: '{line[i]}'",
                      file=sys.stderr)
                self.has_errors = True
                i += 1
