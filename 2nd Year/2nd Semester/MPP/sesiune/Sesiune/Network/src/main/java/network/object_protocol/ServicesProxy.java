...
public class ServicesProxy implements IServices {
    ...
    public List<Joc> getJocuriByJucator(Jucator jucator) {
        GetJocuriRequest request = new GetJocuriRequest(jucator);
        sendRequest(request);
        ...
        GetJocuriResponse resp = (GetJocuriResponse) response;
        return resp.getJocuri();
    }

    @Override
    public List<RaspunsJucator> getRaspunsuriByJoc(Joc joc) {
        GetRaspunsuriRequest request = new GetRaspunsuriRequest(joc);
        sendRequest(request);
        Response response = readResponse();
        ...
        GetRaspunsuriResponse resp = (GetRaspunsuriResponse) response;
        return resp.getRaspunsuri();
    }
}
