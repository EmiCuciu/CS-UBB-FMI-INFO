...
namespace TriatlonPersistance
{
    public class ArbitruRepository : IArbitruRepository
    {
        ...
        public void Save(Arbitru entity)
        {
            ...
            string sql =
                "INSERT INTO Arbitru (username, password, first_name, last_name) VALUES (@username, @password, @firstName, @lastName)";
            try
            {
                using (SQLiteConnection connection = new SQLiteConnection(connectionString))
                {
        ...
        public void Update(Arbitru entity)
        {
            ...
            string sql =
                "UPDATE Arbitru SET username=@username, password=@password, first_name=@firstName, last_name=@lastName WHERE id=@id";
            try
            {
                using (SQLiteConnection connection = new SQLiteConnection(connectionString))
                {
