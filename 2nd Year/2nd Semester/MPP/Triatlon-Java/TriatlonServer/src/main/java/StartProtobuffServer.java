...
import triatlon.persistence.hibernate.HibernateArbitruRepository;
import triatlon.persistence.hibernate.HibernateParticipantRepository;
import triatlon.persistence.hibernate.HibernateProbaRepository;
import triatlon.persistence.hibernate.HibernateRezultatRepository;
...
//        IRezultatRepository rezultatRepository = new RezultatRepository(serverProps, participantRepository, arbitruRepository);
        ...
        IArbitruRepository arbitruRepository = new HibernateArbitruRepository(serverProps);
        IParticipantRepository participantRepository = new HibernateParticipantRepository(serverProps);
        IProbaRepository probaRepository = new HibernateProbaRepository(serverProps);
        IRezultatRepository rezultatRepository = new HibernateRezultatRepository(serverProps);
        ...
        try {
            ...
            triatlon.persistence.hibernate.HibernateUtil.closeSessionFactory();
        }
    }
}