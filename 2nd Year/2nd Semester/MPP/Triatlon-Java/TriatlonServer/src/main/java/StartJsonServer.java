...
import triatlon.network.utils.TriatlonJsonConcurrentServer;
...
public class StartJsonServer {
    ...
    public static void main(String[] args) {
        ...
        logger.info("Starting JSON server on port: {}", serverPort);
        AbstractServer server = new TriatlonJsonConcurrentServer(serverPort, triatlonServices);
        try {
            server.start();
