...
import triatlon.network.protobuffprotocol.ProtoTriatlonProxy;
...
public class StartProtobuffClient extends Application {
    private static final Logger logger = LogManager.getLogger(StartProtobuffClient.class);
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        try {
            clientProps.load(StartProtobuffClient.class.getResourceAsStream("/chatclient.properties"));
        ...
        ITriatlonServices server = new ProtoTriatlonProxy(serverIP, serverPort);
        ...
        primaryStage.setTitle("Triatlon Competition - Protobuf Client");
